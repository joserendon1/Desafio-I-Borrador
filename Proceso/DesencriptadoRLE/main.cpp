...
int main() {
    std::cout << "=== DESENCRIPTADOR ENCRIPTADO3 ===" << std::endl;

    // Parámetros fijos para Encriptado3
    const char* nombreArchivo = "Encriptado3.txt";
    const int rotacion = 3;
    const unsigned char clave = 0x40; // 64 en decimal
